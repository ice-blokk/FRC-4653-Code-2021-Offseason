...
public class StartRightShootThreeBallsThenMoveBackward extends SequentialCommandGroup {
  /** Creates a new ShootThreeBallsThenMoveForward. */
  public StartRightShootThreeBallsThenMoveBackward(Drivetrain drivetrain, Anglers anglers, Cannon cannon,
      Intake intake) {
    addCommands(
      ...
      new ParallelCommandGroup(
          new AutoTurn(-20, -.35, drivetrain).withInterrupt(() -> drivetrain.getLimelight().getValidTarget()),
